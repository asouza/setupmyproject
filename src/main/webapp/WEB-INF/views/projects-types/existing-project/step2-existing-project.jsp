...
<template:page title="${title}">
		<h3>Maven info</h3>
		<form:form commandName="mavenSetupForm" servletRelativeAction="/existing/project/maven">
			<div>
				<label id="icon"><i class="fa fa-briefcase"></i></label>
				<form:input path="basePackage" placeHolder="br.com.yourcompany.currentProjectName"/>
