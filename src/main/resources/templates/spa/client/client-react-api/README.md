...
Please go to `App.js` and change the _URL_ that is been using application context backend
...
If you setted java project name with **explameApi**, change your _fetch_ like below: 
```javascript

fetch("http://localhost:8080/exampleApi/products")

``` 

If you are using SPRING BOOT option, you should remove context name in your _fetch URL_.
